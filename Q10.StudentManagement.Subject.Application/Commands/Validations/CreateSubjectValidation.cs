...
{
    public class CreateSubjectValidation : AbstractValidator<CreateSubjectCommand>
    {
        public CreateSubjectValidation()
        {
            ...
            RuleFor(RuleFor => RuleFor.pCredits)
                ...
                .LessThanOrEqualTo(4).WithName("Creditos de la asignatura").WithMessage("El {PropertyName} debe ser menor o igual a 4.");
        }
    }
}
